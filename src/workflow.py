...
# Here is Extractor
from extractor.details import get_channel_details, get_video_id_by_channel, get_video_id_by_channel_full_refresh
...
detail = get_video_id_by_channel_full_refresh(channel_id,full_refresh=True)
print(detail)